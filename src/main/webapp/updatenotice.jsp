                  ...
                  <div class="row">
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="notice">
                        <h4 style= "border-bottom:1px solid #611122da; padding-bottom: 10px; width: 90%;">공지사항 쓰기</h4>
                        <form action="updateNotice.do" method="post" enctype="multipart/form-data">
                          <table cellpadding="0" cellspacing="0" width="90%" >
                            ...
                            <tr style="text-align:center">
                              <td align="left" style="border: 1px solid #ebecef;"><textarea name="nTITLE" placeholder="제목을 입력해주세요" style="height: 30px; display: block; width: 100%; resize: none;">${notice.NTITLE }</textarea></td> 
                            </tr>
                            ...
                            <tr style="text-align:center">
                              <td align="left"><textarea name="nCON" cols="40" rows="10" placeholder="내용을 입력해주세요" style="height: 300px; width: 100%; resize: none;">${notice.NCON }</textarea></td>
                            </tr>
