            ...
            <div class="row">
              ...
              <div class="col-md-6" style="float: none; margin:0 auto;">
                <div class="aa-myaccount-register">                 
                 <h4>개인정보 수정</h4>
                 <form action="updateUserInfo.do" method="post"  class="aa-login-form">
  					<c:forEach var="row" items="${rs1.rows}" end="0">
	                    <label for="">아이디<span></span></label>
	                    <input type="text" name="mID" value="${row['mID']}" readonly>
	                    <label for="">이름<span></span></label>
	                    <input type="text" name="mNAME" value="${row['mNAME']}" readonly>
