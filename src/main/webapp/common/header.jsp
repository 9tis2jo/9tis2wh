            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  <li><a href="myinfo.jsp">내 계정</a></li>
                  <li class="hidden-xs"><a href="wishlist.jsp">위시 리스트</a></li>
                  <li class="hidden-xs"><a href="jjim.jsp">찜목록</a></li>
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="product-registration.jsp">Sell <span ></span></a>
                
              </li>
              <li><a href="board.jsp">BBS<span></span></a>
                
              </li>
              <li><a href="board-q.jsp">Notice</a></li>
