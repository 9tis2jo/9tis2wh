                        ...
                        <form action="updateBoard.do" method="post" enctype="multipart/form-data">
                          <table cellpadding="0" cellspacing="0" width="90%" >
                            ...
                            <tr style="text-align:center">
                              <td align="left" style="border: 1px solid #ebecef;"><textarea name="bTITLE" placeholder="제목을 입력해주세요" style="height: 30px; display: block; width: 100%; resize: none;">${board.BTITLE }</textarea></td> 
                            </tr>
                            ...
                            <tr style="text-align:center">
                              <td align="left"><textarea name="bCON" cols="40" rows="10" placeholder="내용을 입력해주세요" style="height: 300px; width: 100%; resize: none;">${board.BCON }</textarea></td>
                            </tr>
